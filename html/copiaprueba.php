...
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.16.9/xlsx.full.min.js"></script>
    ...
    // Función para verificar si un elemento está en la parte superior de la ventana
    function isInViewport(element) {
        var rect = element.getBoundingClientRect();
        return rect.top >= 0 && rect.top <= (window.innerHeight || document.documentElement.clientHeight);
    }

    // Función para verificar si los elementos están en la parte superior de la ventana
// Función para verificar si los elementos están en la parte superior de la ventana
    ...
    var btnMT = document.getElementById('btnMT');
        ...
        textBox.style.border = "0px solid #ccc";
    ...
    document.getElementById(dato).addEventListener('paste', function(e) {
        e.preventDefault();
    ...
    function submitContent() {
        var content = document.getElementById(dato).innerHTML;
    ...
    // Escuchar el evento afterprint en el objeto window
