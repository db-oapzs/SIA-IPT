...
window.addEventListener("load", () => {
    ...
    var password1Input = <HTMLInputElement>document.getElementById("passW1");
    var password2Input = <HTMLInputElement>document.getElementById("passW2");
    var btnEntrar = <HTMLElement>document.getElementById("btnEntrar");
